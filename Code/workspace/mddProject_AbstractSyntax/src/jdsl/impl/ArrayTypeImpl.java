 ...
 * <ul>
 *   <li>{@link jdsl.impl.ArrayTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayTypeImpl extends TypeImpl implements ArrayType {
	...
	protected EClass eStaticClass() {
		return JdslPackage.Literals.ARRAY_TYPE;
	}
	...
	public void setType(TypeEnum newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JdslPackage.ARRAY_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JdslPackage.ARRAY_TYPE__TYPE:
				return getType();
		}
