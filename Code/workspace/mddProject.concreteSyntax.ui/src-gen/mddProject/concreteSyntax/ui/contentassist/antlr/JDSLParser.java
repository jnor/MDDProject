		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getContentTypeAccess().getGuidAssignment_6_2(), "rule__ContentType__GuidAssignment_6_2");
					...
					put(grammarAccess.getContentTypeAccess().getModifiedByAssignment_13_2(), "rule__ContentType__ModifiedByAssignment_13_2");
					...
					put(grammarAccess.getPropertyAccess().getTypeAssignment_8_2(), "rule__Property__TypeAssignment_8_2");
