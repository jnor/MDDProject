		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getContentTypeAccess().getGroup_6(), "rule__ContentType__Group_6__0");
					put(grammarAccess.getContentTypeAccess().getGroup_10(), "rule__ContentType__Group_10__0");
					put(grammarAccess.getContentTypeAccess().getGroup_12(), "rule__ContentType__Group_12__0");
					put(grammarAccess.getContentTypeAccess().getGroup_12_3(), "rule__ContentType__Group_12_3__0");
					...
					put(grammarAccess.getSingleTypeAccess().getGroup_6(), "rule__SingleType__Group_6__0");
					put(grammarAccess.getArrayTypeAccess().getGroup(), "rule__ArrayType__Group__0");
					put(grammarAccess.getArrayTypeAccess().getGroup_6(), "rule__ArrayType__Group_6__0");
					...
					put(grammarAccess.getContentTypeAccess().getGuidAssignment_6_1(), "rule__ContentType__GuidAssignment_6_1");
					put(grammarAccess.getContentTypeAccess().getHasPropertiesAssignment_9(), "rule__ContentType__HasPropertiesAssignment_9");
					put(grammarAccess.getContentTypeAccess().getHasPropertiesAssignment_10_1(), "rule__ContentType__HasPropertiesAssignment_10_1");
					put(grammarAccess.getContentTypeAccess().getHasVersionsAssignment_12_2(), "rule__ContentType__HasVersionsAssignment_12_2");
					put(grammarAccess.getContentTypeAccess().getHasVersionsAssignment_12_3_1(), "rule__ContentType__HasVersionsAssignment_12_3_1");
					put(grammarAccess.getContentTypeAccess().getModifiedByAssignment_13_1(), "rule__ContentType__ModifiedByAssignment_13_1");
					put(grammarAccess.getPropertyAccess().getNameAssignment_4(), "rule__Property__NameAssignment_4");
					put(grammarAccess.getPropertyAccess().getAccessModiferAssignment_6(), "rule__Property__AccessModiferAssignment_6");
					put(grammarAccess.getPropertyAccess().getDatatypeAssignment_7_1(), "rule__Property__DatatypeAssignment_7_1");
					put(grammarAccess.getSingleTypeAccess().getNameAssignment_5(), "rule__SingleType__NameAssignment_5");
					put(grammarAccess.getSingleTypeAccess().getTypeAssignment_6_1(), "rule__SingleType__TypeAssignment_6_1");
					put(grammarAccess.getArrayTypeAccess().getNameAssignment_5(), "rule__ArrayType__NameAssignment_5");
					put(grammarAccess.getArrayTypeAccess().getTypeAssignment_6_1(), "rule__ArrayType__TypeAssignment_6_1");
					...
					put(grammarAccess.getUserAccess().getFirstnameAssignment_7_1(), "rule__User__FirstnameAssignment_7_1");
					put(grammarAccess.getUserAccess().getLastnameAssignment_8_1(), "rule__User__LastnameAssignment_8_1");
					put(grammarAccess.getUserAccess().getLoginAssignment_9_1(), "rule__User__LoginAssignment_9_1");
					put(grammarAccess.getUserAccess().getPasswordAssignment_10_1(), "rule__User__PasswordAssignment_10_1");
					put(grammarAccess.getUserAccess().getEmailAssignment_11_1(), "rule__User__EmailAssignment_11_1");
					put(grammarAccess.getUserAccess().getHasRoleAssignment_12_1(), "rule__User__HasRoleAssignment_12_1");
					put(grammarAccess.getVersionAccess().getNameAssignment_2(), "rule__Version__NameAssignment_2");
					put(grammarAccess.getCMSAccess().getNameAssignment_5(), "rule__CMS__NameAssignment_5");
					put(grammarAccess.getCMSAccess().getTypeAssignment_6_1(), "rule__CMS__TypeAssignment_6_1");
					put(grammarAccess.getCMSAccess().getAddress_urlAssignment_7_1(), "rule__CMS__Address_urlAssignment_7_1");
					put(grammarAccess.getCMSAccess().getUsernameAssignment_8_1(), "rule__CMS__UsernameAssignment_8_1");
					put(grammarAccess.getCMSAccess().getPasswordAssignment_9_1(), "rule__CMS__PasswordAssignment_9_1");
				}
			};
		}
