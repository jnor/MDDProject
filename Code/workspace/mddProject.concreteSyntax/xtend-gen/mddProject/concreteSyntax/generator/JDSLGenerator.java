...
public class JDSLGenerator implements IGenerator {
  ...
  public CharSequence toN2PropertyDateTime(final Property p) {
    ...
    String _name_3 = p.getName();
    String _string_3 = _name_3.toString();
    String _lowerCase_1 = _string_3.toLowerCase();
    _builder.append(_lowerCase_1, "		");
    _builder.append(" = value;}");
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
  ...
  public CharSequence toN2CodeBehindFile(final ContentType ct) {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public partial class _");
    String _name = ct.getName();
    String _firstUpper = StringExtensions.toFirstUpper(_name);
    _builder.append(_firstUpper, "	");
    _builder.append(" : N2.Web.UI.Page<Items.");
    String _name_1 = ct.getName();
    String _firstUpper_1 = StringExtensions.toFirstUpper(_name_1);
    _builder.append(_firstUpper_1, "	");
    _builder.append(">");
  ...
  public CharSequence toN2AspxFile(final ContentType ct) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("\t");
    _builder.append("<%@ Page Language=\"C#\" AutoEventWireup=\"true\" CodeFile=\"");
    String _name = ct.getName();
    String _firstUpper = StringExtensions.toFirstUpper(_name);
    _builder.append(_firstUpper, "	");
    _builder.append(".aspx.cs\" Inherits=\"_Default\" %>");
    _builder.newLineIfNotEmpty();
    _builder.newLine();
