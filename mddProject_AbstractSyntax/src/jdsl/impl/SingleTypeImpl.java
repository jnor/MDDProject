 ...
 * <ul>
 *   <li>{@link jdsl.impl.SingleTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SingleTypeImpl extends TypeImpl implements SingleType {
	/**
	...
	protected EClass eStaticClass() {
		return JdslPackage.Literals.SINGLE_TYPE;
	}
	...
	public void setType(TypeEnum newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JdslPackage.SINGLE_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JdslPackage.SINGLE_TYPE__TYPE:
				return getType();
		}
