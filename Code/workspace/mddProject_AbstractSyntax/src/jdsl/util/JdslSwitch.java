 ...
 * @generated
 */
public class JdslSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JdslPackage.NAMED_ELEMENT: {
			...
			case JdslPackage.CONTENT_TYPE: {
				...
				if (result == null) result = caseNamedElement(contentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JdslPackage.CMS: {
				...
				if (result == null) result = caseNamedElement(cms);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
